          ...
          {stats.map((stat, index) => (
            <div key={index} className="stat-item">
              <div className="flex justify-center mb-4">
                <div className="w-16 h-16 bg-gradient-to-br from-magenta-500 to-purple-600 rounded-full flex items-center justify-center">
                  <stat.icon className="h-8 w-8 text-white" />
                </div>
              </div>
              <h3
                className="stat-value text-4xl md:text-5xl font-bold text-white"
